...
class PaymentAcquirerStripe(models.Model):
    ...
    def rave_form_generate_values(self, tx_values):
        ...
        temp_rave_tx_values = {
            ...
            "address_country": tx_values.get("partner_country")
            and tx_values.get("partner_country").name
            or "",
...
class PaymentTransactionRave(models.Model):
    ...
    def _rave_verify_charge(self, data):
        ...
        _logger.info(
            "_rave_verify_charge: Sending values to URL %s, values:\n%s",
            api_url_charge,
    ...
    def _rave_validate_tree(self, tree, data):
        ...
        if self.state != "draft":
            _logger.info(
                "Rave: trying to validate an already validated tx (ref %s)",
                self.reference,
            )
            return True
