...
class PersonAuxDocumentSetUp(models.TransientModel):
    _description = 'Person (Aux) Document Setup'
    _name = 'clv.person_aux.document_setup'

    def _default_person_aux_ids(self):
        return self._context.get('active_ids')
    person_aux_ids = fields.Many2many(
        comodel_name='clv.person_aux',
        relation='clv_person_aux_document_setup_rel',
        string='Persons (Aux)',
    ...
    document_type_ids = fields.Many2many(
        ...
        relation='clv_person_aux_document_setup_document_type_rel',
