...
class PersonAssociateToSet(models.TransientModel):
    _description = 'Person Associate to Set'
    _name = 'clv.person.associate_to_set'

    def _default_person_ids(self):
        return self._context.get('active_ids')
    person_ids = fields.Many2many(
        comodel_name='clv.person',
        relation='clv_person_associate_to_set_rel',
        string='Persons',
    ...
    @api.multi
    def do_person_associate_to_set(self):
        self.ensure_one()
