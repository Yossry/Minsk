...
class HRStaffSalaryDifferenceLine(models.Model):
	_name = 'hr.staff.salary.difference.line'
	_description = "HR Staff Salary Difference Details"	
	
	
	employee_id = fields.Many2one('hr.employee', 'Employee', required=True)
	amount = fields.Float(string='Amount', required=True)
	difference_id = fields.Many2one('hr.staff.salary.difference','Salary Difference')
