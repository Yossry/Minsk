...
class ReportWeaponPostAll(models.AbstractModel):
	_name = 'report.sos_uniform.report_weaponpostall'
	_description = 'All Posts Weapon Report'
	...
	def _get_report_values(self, docids, data=None):
		...
		for post in posts:
			...
			demands = self.env['sos.weapon.demand'].search(dom)
		...
		report = self.env['ir.actions.report']._get_report_from_name('sos_uniform.report_weaponpostall')
		return {
			"doc_ids": self._ids,
