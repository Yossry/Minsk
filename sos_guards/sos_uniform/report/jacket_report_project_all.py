...
class ReportJacketProjectAll(models.AbstractModel):
	_name = 'report.sos_uniform.report_jacketprojectall'
	_description = 'All Project Jacket Report'
	...
	def _get_report_values(self, docids, data=None):
		...
		report = self.env['ir.actions.report']._get_report_from_name('sos_uniform.report_jacketprojectall')
		return {
			"doc_ids": self._ids,
