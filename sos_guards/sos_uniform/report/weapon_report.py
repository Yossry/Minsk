...
class ReportWeapon(models.AbstractModel):
	...
	_description = 'SOS Weapon Report'
	...
	def _get_report_values(self, docids, data=None):
		...
		weapons = self.env['sos.weapon.demand'].search([('date', '>=', date_from),('date','<=', date_to), ('state', '<>', 'reject')],order='date,center_id, post_id')
