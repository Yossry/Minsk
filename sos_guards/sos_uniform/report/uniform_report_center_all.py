...
class ReportUniformCenterAll(models.AbstractModel):
	_name = 'report.sos_uniform.report_uniformcenterall'
	_description = 'All Centers Uniform Report'
	...
	def _get_report_values(self, docids, data=None):
		...
		report = self.env['ir.actions.report']._get_report_from_name('sos_uniform.report_uniformcenterall')
		return {
			"doc_ids": self._ids,
