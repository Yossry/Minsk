...
class GuardMBLDeduction(models.TransientModel):
	_name = "sos.guards.mbl.deduction"
	_description = "MBL Deduction Wizard"
	...
	def print_report(self):
		...
		return self.env.ref('sos_payroll.report_mbl_deduction').with_context(landscape=True).report_action(self, data=datas)
