...
class sos_staff_gross_salary_sheet_wizard(models.TransientModel):
	_name = 'sos.staff.gross.salary.sheet.wizard'
	_description = 'Staff Gross Salary Sheet Wizard'
	...
	segment_wise = fields.Selection([('yes','Yes'),('no','NO')], default='yes', string="Salary Report By Segment")
	...
	def print_report(self):
		...
		return self.env.ref('sos.report_sos_staff_gross_salary_sheet').with_context(landscape=True).report_action(self, data=datas)
