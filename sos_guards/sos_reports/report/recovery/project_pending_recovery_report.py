...
class ReportProjectPendingRecovery(models.AbstractModel):
	_name = 'report.sos_reports.project_report_pendingrecovery'
	...
	def render_html(self, data=None):
		...
		report = report_obj._get_report_from_name('sos_reports.project_report_pendingrecovery')
		docargs = {
			"doc_ids": self._ids,
		...
		return report_obj.render('sos_reports.project_report_pendingrecovery', docargs)
